...
class Storage {
    ...
    static addWorkout (workout){
        const workoutArray = this.getWorkouts();
    ...
    static removeWorkout(id){
        const workout = this.getWorkouts();
        
        const newWorkouts = workout.filter((w)=>{
            return w.id !== id
        })
    ...
    static reset () {
        const array= ['calorieLimit','workouts','meals','totalCalorie'];
        array.forEach((a)=>{
